        ...
        rows.append(
            {
                ...
                "ContractorName": f"Demo Contractor {chr(64 + index)}",
            ...
            status_history.append(
                {
                    ...
                    "UpdatedBy": f"Demo User {random.randint(1, 18):02d}",
                    "SourceSystem": "Synthetic Progress Tracker",
                    "Comment": random.choice(
                        [
                            "Synthetic update generated for demo reporting.",
                            "Planned workflow transition for portfolio dataset.",
                            "Demo progress event created from scripted scenario.",
                            "Fictional site update for dashboard testing.",
                        ]
                    ),
